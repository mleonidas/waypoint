...
// RunnerGetInfraConfig provides a mock function with given fields: _a0, _a1
func (_m *WaypointServer) RunnerGetInfraConfig(_a0 context.Context, _a1 *gen.RunnerGetInfraConfigRequest) (*gen.RunnerGetInfraConfigResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *gen.RunnerGetInfraConfigResponse
	if rf, ok := ret.Get(0).(func(context.Context, *gen.RunnerGetInfraConfigRequest) *gen.RunnerGetInfraConfigResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *gen.RunnerGetInfraConfigRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *WaypointServer) UpsertInfrastructure(_a0 context.Context, _a1 *gen.UpsertInfraRequest) (*gen.UpsertInfraResponse, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, *gen.UpsertInfraRequest) *gen.UpsertInfraResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *gen.UpsertInfraRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
