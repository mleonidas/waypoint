...
// RunnerGetInfraConfig provides a mock function with given fields: ctx, in, opts
func (_m *WaypointClient) RunnerGetInfraConfig(ctx context.Context, in *gen.RunnerGetInfraConfigRequest, opts ...grpc.CallOption) (*gen.RunnerGetInfraConfigResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *gen.RunnerGetInfraConfigResponse
	if rf, ok := ret.Get(0).(func(context.Context, *gen.RunnerGetInfraConfigRequest, ...grpc.CallOption) *gen.RunnerGetInfraConfigResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*gen.RunnerGetInfraConfigResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *gen.RunnerGetInfraConfigRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *WaypointClient) UpsertInfra(ctx context.Context, in *gen.UpsertInfraRequest, opts ...grpc.CallOption) (*gen.UpsertInfraResponse, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, *gen.UpsertInfraRequest, ...grpc.CallOption) *gen.UpsertInfraResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*gen.UpsertInfraResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *gen.UpsertInfraRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
